...
function resizeRoot(){
	...
	//document.getElementById('wc_wrapper').style.height = window.screen.height - (document.getElementsByClassName('suc_box').style.height +document.getElementsByClassName('footer').style.height )  +'px';
